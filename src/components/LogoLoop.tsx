  ...
  ({
    ...
    const renderLogoItem = useCallback(
      (item: LogoItem, key: React.Key) => {
        ...
        const visual = isNodeItem ? (
          <span aria-hidden={!!itemTitle}>{item.node}</span>
        ) : (
          <img
            className={cx(
              "h-[1em] w-auto block object-contain",
        ...
        const content = (
          ...
          >
            <span className="inline-flex h-[var(--logoloop-logoHeight)] items-center text-[length:var(--logoloop-logoHeight)] leading-none">
              {visual}
            </span>
            {itemTitle && (
    ...
    return (
      ...
      >
            ...
            {isVertical ? (
              ...
              <>
                <div
                  aria-hidden
                  className={cx(
                    "pointer-events-none absolute inset-y-0 left-0 z-11",
                ...
                <div
                  aria-hidden
                  className={cx(
                    "pointer-events-none absolute inset-y-0 right-0 z-11",
                    "w-[clamp(24px,8%,120px)]",
        ...
        <div
          className={cx(
            "flex will-change-transform select-none relative z-10",
